...
def test_deployed_model_predict(
    project: str,
    location: str,
    endpoint: str,
    endpoint_name: str,
    ...
    # _endpoint_details = aiplatform.Endpoint.list(
        # filter=f'display_name="{endpoint_name}"'
    # )[0]
    # _endpoint_uri = _endpoint_details.resource_name

    # define endpoint resource in component
    _endpoint = aiplatform.Endpoint(_endpoint_uri)
    logging.info(f"endpoint defined")
